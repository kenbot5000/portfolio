...
import PortfolioIconCard from '@/components/PortfolioIconCard.vue';
...
<template>
  <div class="flex flex-col">
    ...
    <div class="grid grid-cols-2 xl:grid-cols-3 items-center mx-auto my-auto px-10 gap-x-4 gap-y-4">
      <DisplayCard
        v-for="(val, i) in text"
        :id="val.id"
        :key="i"
